...
public class TeslaSemi extends ElectricTruck {
	...
	@Override
	void start() {
		System.out.println("TeslaSemi - load starts by pressing the button");
		
	}

	@Override
	void charge() {
	System.out.println("TeslaSemi is charging by electric");
		
	}

	@Override
	void drive() {
		System.out.println("TeslaSemi is driven without driver");
